...
Проект для подбора фильмов “по вайбу”: **статический фронт** показывает карточки фильмов, **API** отдаёт фильмы/постеры/отзывы и хранит лайки/дизлайки/отзывы, **Telegram‑бот** создаёт пользователя и выдаёт ссылку на WebApp.
